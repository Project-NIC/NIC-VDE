...
TABLES: dict[str, dict[str, str]] = {
    ...
    "cs": {
        ...
        "View": "Zobrazit", "Values": "Hodnoty", "Copy": "Kopírovat",
    ...
    "ru": {
        ...
        "Re-read": "Перечитать",
        "Language": "Язык", "Save setup": "Сохранить настройки",
    },
}
