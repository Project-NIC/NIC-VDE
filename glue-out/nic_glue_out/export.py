...
It knows nothing about MLA or the glue: you hand it column names and rows of
values, it hands back bytes. This keeps the reader thin — it decides *what* the
rows are; this decides *how* they are serialised. The same split NIC-VDE uses,
so the two stay interchangeable. Pure stdlib, no external packages.
"""
