...
Celá **Arduino rodina** NIC na jednom místě — softwarová/datová strana NIC.
Každá součást si drží svůj název i svoje README a zůstává použitelná samostatně
(drop-in, ve stylu Arduino knihovny).
...
datové strany a stojí samo o sobě. Je záměrně jednoduché.
