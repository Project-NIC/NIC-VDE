...
class CsvTests(unittest.TestCase):
    def test_header_and_rows(self):
        out = export.vde_to_csv(["a", "b"], [(1, 2), (3, 4)]).decode("utf-8")
        self.assertEqual(out, "a,b\n1,2\n3,4\n")

    def test_none_becomes_blank(self):
        out = export.vde_to_csv(["a", "b"], [(1, None)]).decode("utf-8")
        self.assertEqual(out.strip().split("\n")[1], "1,")

    def test_commas_and_newlines_sanitised(self):
        out = export.vde_to_csv(["x"], [("a,b\nc",)]).decode("utf-8")
...
class SqliteTests(unittest.TestCase):
    ...
    def test_roundtrip_values(self):
        blob = export.vde_to_sqlite([("n", "INTEGER"), ("v", "NUMERIC")],
                                [(1, 23.5), (2, -1.5)])
    ...
    def test_messy_names_become_safe_unique_idents(self):
        ...
        blob = export.vde_to_sqlite([("a b", "TEXT"), ("a/b", "TEXT")], [("x", "y")])
